...
export class TestAssertions {
  // Assert API response
  static assertApiResponse(response: any, expectedStatus: number, expectedData?: any): void {
  ...
  static assertErrorResponse(response: any, expectedCode: string, expectedMessage?: string): void {
  ...
  static assertDatabaseRecord(record: any, expectedData: any): void {
  ...
  static assertValidationError(error: any, expectedField: string, expectedMessage?: string): void {
