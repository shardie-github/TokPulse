...
export class ErrorTracker {
  ...
  private determineErrorLevel(error: Error): 'critical' | 'high' | 'medium' | 'low' {
    ...
    const highErrors = ['NetworkError', 'TimeoutError', 'ServiceUnavailableError'];

    const mediumErrors = ['NotFoundError', 'BadRequestError', 'ConflictError'];
