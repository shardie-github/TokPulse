...
export class TelemetryTracing {
    ...
    createWebhookSpan(topic, storeId, operation) {
    ...
    createWidgetSpan(surface, storeId, operation) {
    ...
    createApiSpan(method, route, storeId) {
    ...
    createJobSpan(jobType, storeId, operation) {
    ...
    createExperimentSpan(experimentId, operation, storeId) {
