...
// API handlers
export async function getActiveExperiments(request) {
    try {
...
export async function getAssignment(request) {
    try {
        ...
        logger.error('Failed to get experiment assignment', error, {
            orgId: request.orgId,
            storeId: request.storeId,
            experimentKey: request.experimentKey
        });
...
export async function recordExposure(request) {
    try {
        ...
        logger.error('Failed to record experiment exposure', error, {
            orgId: request.orgId,
            storeId: request.storeId,
            experimentKey: request.experimentKey,
            surface: request.surface
...
export async function updateExperiment(request) {
    try {
        // In a real implementation, this would:
        // 1. Validate the request
...
export async function deleteExperiment(request) {
    try {
        // In a real implementation, this would:
        // 1. Validate the request
...
export async function startExperiment(experimentId, orgId) {
    try {
        // In a real implementation, this would:
...
export async function pauseExperiment(experimentId, orgId) {
    try {
        // In a real implementation, this would:
