...
import {
  ...
  d as te,
  e as ee,
} from './assets/defaultSettingsView-w0zYjHsW.js';
var se = {};
class dt {
  constructor(t, e = {}) {
    ((this.isListing = !1),
      (this._tests = new Map()),
      (this._rootSuite = new X('', 'root')),
      (this._options = e),
      (this._reporter = t));
  }
  reset() {
  ...
  _onProject(t) {
    let e = this._options.mergeProjects
      ...
      : void 0;
    (e || ((e = new X(t.name, 'project')), this._rootSuite._addSuite(e)),
  ...
  _onTestEnd(t, e) {
    ...
    ((i.duration = e.duration),
      ...
      (m = (n = this._reporter).onTestEnd) == null || m.call(n, s, i),
      (i._stepMap = new Map()));
  }
  _onStepBegin(t, e, s) {
    var f, a;
    const i = this._tests.get(t),
      ...
      c = new oe(s, n, m, d);
    (n ? n.steps.push(c) : d.steps.push(c),
      d._stepMap.set(s.id, c),
  ...
  _onStepEnd(t, e, s) {
    ...
    ((n._endPayload = s),
      ...
      (n.error = s.error),
      (c = (m = this._reporter).onStepEnd) == null || c.call(m, i, d, n));
  }
  _onAttach(t, e, s) {
    this._tests
      .get(t)
  ...
  _onStdIO(t, e, s, i, d) {
    ...
    t === 'stdout'
      ? (c == null || c.stdout.push(n),
        (a = (f = this._reporter).onStdOut) == null || a.call(f, n, m, c))
      : (c == null || c.stderr.push(n),
  ...
  _parseProject(t) {
    return {
      ...
      testIgnore: rt(t.testIgnore),
      testMatch: rt(t.testMatch),
      timeout: t.timeout,
      grep: rt(t.grep),
      grepInvert: rt(t.grepInvert),
  ...
  _mergeSuiteInto(t, e) {
    ...
    (s || ((s = new X(t.title, e.type === 'project' ? 'file' : 'describe')), e._addSuite(s)),
  ...
  _mergeTestInto(t, e) {
    let s = this._options.mergeTestCases
      ...
      : void 0;
    (s ||
      ((s = new ie(t.testId, t.title, this._absoluteLocation(t.location), t.repeatEachIndex)),
      e._addTest(s),
...
class ie {
  ...
  _createTestResult(t) {
    const e = new re(this.results.length, t);
...
function rt(o) {
  return o.map((t) => (t.s !== void 0 ? t.s : new RegExp(t.r.source, t.r.flags)));
}
function ae(o) {
  let t = 0,
    e = 0,
  ...
  for (const i of o.results)
    i.status === 'interrupted' ||
      (i.status === 'skipped' && o.expectedStatus === 'skipped'
        ? ++t
        : i.status === 'skipped' || (i.status === o.expectedStatus ? ++e : ++s));
  return e === 0 && s === 0
    ? 'skipped'
    : s === 0
      ? 'expected'
...
class ut {
  constructor(t, e, s, i, d, n) {
    ...
    const c = (f, a, w, x) => {
      for (const l of x === 'tests' ? [] : a.suites) {
        if (!l.title) {
          c(f, l, w, 'all');
          continue;
        }
        let T = w.children.find((_) => _.kind === 'group' && _.title === l.title);
        (T ||
          ((T = {
            kind: 'group',
            subKind: 'describe',
            id: 'suite:' + a.titlePath().join('') + '' + l.title,
            title: l.title,
            location: l.location,
            duration: 0,
            parent: w,
      ...
      for (const l of x === 'suites' ? [] : a.tests) {
        const T = l.title;
        let _ = w.children.find((N) => N.kind !== 'group' && N.title === T);
        _ ||
          ((_ = {
            kind: 'case',
            id: 'test:' + l.titlePath().join(''),
            title: T,
            parent: w,
            children: [],
            tests: [],
        ...
        const b = l.results[0];
        let R = 'none';
        ((b == null ? void 0 : b[J]) === 'scheduled'
          ? (R = 'scheduled')
          : (b == null ? void 0 : b[J]) === 'running'
            ? (R = 'running')
            : (b == null ? void 0 : b.status) === 'skipped'
              ? (R = 'skipped')
              : (b == null ? void 0 : b.status) === 'interrupted'
                ? (R = 'none')
                : b && l.outcome() !== 'expected'
                  ? (R = 'failed')
                  : b && l.outcome() === 'expected' && (R = 'passed'),
          _.tests.push(l));
        const k = {
          kind: 'test',
          id: l.id,
        ...
        (this._addChild(_, k),
          this._treeItemByTestId.set(l.id, k),
          (_.duration = _.children.reduce((N, D) => N + D.duration, 0)));
      }
    };
    for (const f of (e == null ? void 0 : e.suites) || [])
      if (!(m && !i.get(f.title)))
        for (const a of f.suites)
          if (n) {
            if ((c(f.project(), a, this.rootItem, 'suites'), a.tests.length)) {
              const w = this._defaultDescribeItem();
              c(f.project(), a, w, 'tests');
            }
          } else {
            const w = this._fileItem(a.location.file.split(d), !0);
            c(f.project(), a, w, 'all');
          }
    for (const f of s) {
      if (!f.location) continue;
      const a = this._fileItem(f.location.file.split(d), !0);
      a.hasLoadErrors = !0;
    }
  }
  _addChild(t, e) {
  ...
  filterTree(t, e, s) {
    const i = t.trim().toLowerCase().split(' '),
      ...
      n = (c) => {
        const f = [...c.tests[0].titlePath(), ...c.tests[0].tags].join(' ').toLowerCase();
        return !i.every((a) => f.includes(a)) &&
          !c.tests.some((a) => (s == null ? void 0 : s.has(a.id)))
          ? !1
          : ((c.children = c.children.filter(
              (a) => !d || (s == null ? void 0 : s.has(a.test.id)) || e.get(a.status),
            )),
            (c.tests = c.children.map((a) => a.test)),
            !!c.children.length);
      },
      m = (c) => {
        const f = [];
        for (const a of c.children)
          a.kind === 'case'
            ? n(a) && f.push(a)
            : (m(a), (a.children.length || a.hasLoadErrors) && f.push(a));
        c.children = f;
      };
    m(this.rootItem);
  }
  _fileItem(t, e) {
    ...
    return (this._addChild(d, n), n);
  }
  _defaultDescribeItem() {
    let t = this._treeItemById.get('<anonymous>');
    return (
      t ||
        ((t = {
          kind: 'group',
        ...
        this._addChild(this.rootItem, t)),
      t
    );
  }
  ...
  collectTestIds(t) {
    return t ? le(t) : new Set();
  }
}
function Tt(o) {
  for (const n of o.children) Tt(n);
  o.kind === 'group' &&
    o.children.sort(
      (n, m) => n.location.file.localeCompare(m.location.file) || n.location.line - m.location.line,
    );
...
class ce {
  ...
  _createReporter() {
    return {
      ...
      onTestBegin: (t, e) => {
        ((e[J] = 'running'), this._options.onUpdate());
      },
      onTestEnd: (t, e) => {
        (t.outcome() === 'skipped'
  ...
  asModel() {
    return {
      rootSuite: this.rootSuite || new X('', 'root'),
      config: this.config,
...
const de = ({ source: o }) => {
    const [t, e] = At(),
      ...
      [d] = K.useState(
        Wt(
          () => import('./assets/xtermModule-CsJ4vdCR.js'),
          __vite__mapDeps([0, 1]),
          import.meta.url,
        ).then((m) => m.default),
      ),
      n = K.useRef(null);
    return (
      K.useEffect(() => (zt(i), () => Vt(i)), []),
      K.useEffect(() => {
        const m = o.write,
          c = o.clear;
        return (
          (async () => {
            const { Terminal: f, FitAddon: a } = await d,
              w = e.current;
            if (!w) return;
            const x = s === 'dark-mode' ? he : ue;
            if (n.current && n.current.terminal.options.theme === x) return;
            n.current && (w.textContent = '');
            const l = new f({
                convertEol: !0,
                fontSize: 13,
                scrollback: 1e4,
              ...
              T = new a();
            l.loadAddon(T);
            for (const _ of o.pending) l.write(_);
            ((o.write = (_) => {
              (o.pending.push(_), l.write(_));
            }),
              (o.clear = () => {
                ((o.pending = []), l.clear());
              }),
              l.open(w),
              T.fit(),
              (n.current = { terminal: l, fitAddon: T }));
          })(),
          () => {
            ((o.clear = c), (o.write = m));
          }
      ...
      K.useEffect(() => {
        setTimeout(() => {
          n.current &&
            (n.current.fitAddon.fit(), o.resize(n.current.terminal.cols, n.current.terminal.rows));
        }, 250);
      }, [t, o]),
      r.jsx('div', {
        'data-testid': 'output',
...
Projects: ` +
                        ...
                        children: [
                          r.jsx('input', {
                            ...
                            onChange: () => {
                              ...
                              (_.set(l, !_.get(l)), d(_));
                              const b =
                                (R = n == null ? void 0 : n.config) == null ? void 0 : R.configFile;
                              b &&
                                xt.setObject(
                                  b + ':projects',
                                  [..._.entries()].filter(([k, N]) => N).map(([k]) => k),
                                );
                            },
                          }),
                          r.jsx('div', { children: l || 'untitled' }),
                        ],
                      }),
                    },
                    l,
  ...
  pe = ({ tag: o, style: t, onClick: e }) =>
    r.jsx('span', {
      className: ht('tag', `tag-color-${ge(o)}`),
      onClick: e,
...
const me = Ht,
  _e = ({
    ...
    requestedExpandAllCount: x,
    setFilterText: l,
    onRevealSource: T,
  }) => {
    const [_, b] = u.useState({ expandedItems: new Map() }),
      [R, k] = u.useState(),
      [N, D] = u.useState(w),
      [$, L] = u.useState(x);
    u.useEffect(() => {
      if (N !== w) {
        _.expandedItems.clear();
        for (const S of s.flatTreeItems()) _.expandedItems.set(S.id, !1);
        (D(w), k(void 0), b({ ..._ }));
        return;
      }
      if ($ !== x) {
        _.expandedItems.clear();
        for (const S of s.flatTreeItems()) _.expandedItems.set(S.id, !0);
        (L(x), k(void 0), b({ ..._ }));
        return;
      }
      ...
      const E = (S) => {
        ...
        (S.children.forEach(E),
          !h &&
            S.status === 'failed' &&
            ((S.kind === 'test' && d.testIds.has(S.test.id)) ||
              (S.kind === 'case' && d.testIds.has((M = S.tests[0]) == null ? void 0 : M.id))) &&
            (h = S));
      };
      (E(s.rootItem), h && k(h.id));
    }, [d, k, s, N, D, w, $, L, x, _, b]);
    const C = u.useMemo(() => {
      if (R) return s.treeItemById(R);
    }, [R, s]);
    (u.useEffect(() => {
      if (!t) return;
      const h = ve(C, t);
      ...
      ((C == null ? void 0 : C.kind) === 'test'
        ? (E = C.test)
        : (C == null ? void 0 : C.kind) === 'case' && C.tests.length === 1 && (E = C.tests[0]),
        a({ treeItem: C, testCase: E, testFile: h }));
    }, [t, C, a]),
      u.useEffect(() => {
        if (!f)
          if (n) e == null || e.watchNoReply({ fileNames: s.fileNames() });
            ...
            for (const E of m.value) {
              const S = s.treeItemById(E),
                M = S == null ? void 0 : S.location.file;
              M && h.add(M);
            }
            e == null || e.watchNoReply({ fileNames: [...h] });
          }
      }, [f, s, n, m, e]));
    const Z = (h) => {
        (k(h.id), i('bounce-if-busy', s.collectTestIds(h)));
      },
      q = (h, E) => {
        if ((h.preventDefault(), h.stopPropagation(), h.metaKey || h.ctrlKey)) {
          const S = o.split(' ');
          S.includes(E)
            ? l(
                S.filter((M) => M !== E)
    ...
    return r.jsx(me, {
        ...
        return r.jsxs('div', {
          ...
          children: [
            r.jsxs('div', {
              ...
              children: [
                r.jsx('span', { children: h.title }),
                h.kind === 'case'
                  ? h.tags.map((Y) => r.jsx(pe, { tag: Y.slice(1), onClick: (G) => q(G, Y) }, Y))
                  : null,
              ],
            }),
            !!h.duration &&
            ...
            r.jsxs(H, {
              ...
              children: [
                ...
                r.jsx(O, {
                  ...
                  onClick: T,
                  style:
                    h.kind === 'group' && h.subKind === 'folder' ? { visibility: 'hidden' } : {},
                }),
                !n &&
                  r.jsx(O, {
                    icon: 'eye',
                    title: 'Watch',
                    onClick: () => {
                      (m.value.has(h.id) ? m.value.delete(h.id) : m.value.add(h.id), c({ ...m }));
                    },
                    toggled: m.value.has(h.id),
                  }),
              ],
            }),
          ],
      ...
      onAccepted: Z,
      onSelected: (h) => {
        (d && (d.itemSelectedByUser = !0), k(h.id));
      },
      isError: (h) => (h.kind === 'group' ? h.hasLoadErrors : !1),
...
const be = ({ item: o, rootDir: t, onOpenExternally: e, revealSource: s, pathSeparator: i }) => {
    ...
    const [d, n] = u.useState(void 0),
      ...
      { outputDir: a } = u.useMemo(
        () => ({ outputDir: o.testCase ? xe(o.testCase) : void 0 }),
        [o],
      );
    return (
      u.useEffect(() => {
        ...
        const T = l && l.duration >= 0 && l.attachments.find((k) => k.name === 'trace');
        if (T && T.path) {
          vt(T.path).then((k) => n({ model: k, isLive: !1 }));
          return;
        }
        if (!a) {
          n(void 0);
        ...
        const _ = [
          ...
          we(l.workerIndex),
          'traces',
          `${(R = o.testCase) == null ? void 0 : R.id}.json`,
        ].join(i);
        return (
          (f.current = setTimeout(async () => {
            try {
              ...
              const k = new St([]);
              (k.errorDescriptors.push(
                ...l.errors.flatMap((N) => (N.message ? [{ message: N.message }] : [])),
              ),
                n({ model: k, isLive: !1 }));
            } finally {
              c(m + 1);
      ...
      r.jsx(
        Yt,
        {
          ...
          status: (w = o.treeItem) == null ? void 0 : w.status,
          annotations: ((x = o.testCase) == null ? void 0 : x.annotations) ?? [],
          onOpenExternally: e,
          revealSource: s,
        },
        'workbench',
...
async function vt(o) {
  ...
  (t.set('trace', o), t.set('limit', '1'));
  const s = await (await fetch(`contexts?${t.toString()}`)).json();
  return new St(s);
}
let wt = { cols: 80 };
const z = { pending: [], clear: () => {}, write: (o) => z.pending.push(o), resize: () => {} },
  A = new URLSearchParams(window.location.search),
  Se = new URL(A.get('server') ?? '../', window.location.href),
  ft = new URL(A.get('ws'), Se);
ft.protocol = ft.protocol === 'https:' ? 'wss:' : 'ws:';
const B = {
  args: A.getAll('arg'),
...
B.updateSnapshots &&
  !['all', 'changed', 'none', 'missing'].includes(B.updateSnapshots) &&
...
const bt = navigator.platform === 'MacIntel',
  Te = ({}) => {
    ...
    const [o, t] = u.useState(''),
      ...
      [c, f] = u.useState(new Map()),
      [a, w] = u.useState(),
      [x, l] = u.useState(),
      [T, _] = u.useState({}),
      [b, R] = u.useState(new Set()),
      [k, N] = u.useState(!1),
      [D, $] = u.useState(),
      L = D && !D.completed,
      [C, Z] = ot('watch-all', !1),
      [q, h] = u.useState({ value: new Set() }),
      ...
      [st, Bt] = u.useState(!1),
      [Ct, mt] = u.useState(!1),
      Nt = u.useCallback(() => mt(!0), [mt]),
      [nt, Pt] = ot('single-worker', !1),
      [at, Lt] = ot('updateSnapshots', 'missing'),
      [Q] = ot('mergeFiles', !1),
      Dt = u.useRef(null),
      it = u.useCallback(() => {
    ...
    (u.useEffect(() => {
      ...
      u.useEffect(() => {
        ...
        return (
          (z.resize = (g, j) => {
            ((wt = { cols: g, rows: j }), v.resizeTerminalNoReply({ cols: g, rows: j }));
          }),
          () => {
...
`,
        ...
        return (
          ...
          (async () => {
            try {
              ...
              const { status: j, report: I } = await v.runGlobalSetup({});
              if ((g.processGlobalReport(I), j !== 'passed')) return;
              ...
              (g.processListReport(P.report),
                v.onReport((F) => {
                  g.processTestReportEvent(F);
                }));
              const { hasBrowsers: U } = await v.checkBrowsers({});
              gt(U);
            } finally {
              N(!1);
            }
      ...
      u.useEffect(() => {
        if (!a) return;
        const { config: p, rootSuite: g } = a,
          j = p.configFile ? xt.getObject(p.configFile + ':projects', void 0) : void 0,
          I = new Map(c);
        for (const P of I.keys()) g.suites.find((U) => U.title === P) || I.delete(P);
        for (const P of g.suites)
          I.has(P.title) || I.set(P.title, !!(j != null && j.includes(P.title)));
        (!j && I.size && ![...I.values()].includes(!0) && I.set(I.entries().next().value[0], !0),
          (c.size !== I.size || [...c].some(([P, U]) => I.get(P) !== U)) && f(I));
      }, [c, a]),
      u.useEffect(() => {
        L && a != null && a.progress ? l(a.progress) : a || l(void 0);
      }, [a, L]));
    const { testTree: Mt } = u.useMemo(() => {
        if (!a) return { testTree: new ut('', new X('', 'root'), [], c, B.pathSeparator, Q) };
        const p = new ut('', a.rootSuite, a.loadErrors, c, B.pathSeparator, Q);
        return (
          p.filterTree(o, n, L ? (D == null ? void 0 : D.testIds) : void 0),
        ...
        (p, g) => {
          !v ||
            ...
            (E.current = E.current.then(async () => {
              ...
              {
                for (const y of ((P = a.rootSuite) == null ? void 0 : P.allTests()) || [])
                  if (j.has(y.id)) {
                    y.results = [];
              ...
              (z.write('\x1B[2m—'.repeat(Math.max(0, wt.cols - I.length)) + I + '\x1B[22m'),
                l({ total: 0, passed: 0, failed: 0, skipped: 0 }),
                $({ testIds: j }),
                await v.runTests({
                  locations: B.args,
                  grep: B.grep,
                  grepInvert: B.grepInvert,
                  testIds: [...j],
                  projects: [...c].filter(([y, W]) => W).map(([y]) => y),
                  updateSnapshots: at,
                  reporters: B.reporters,
                  workers: nt ? 1 : void 0,
                  trace: 'on',
                }));
              for (const y of ((U = a.rootSuite) == null ? void 0 : U.allTests()) || [])
                ((F = y.results[0]) == null ? void 0 : F.duration) === -1 && (y.results = []);
              (w({ ...a }), $((y) => (y ? { ...y, completed: !0 } : void 0)));
            })));
        },
        [c, L, a, v, at, nt],
      );
    (u.useEffect(() => {
      if (!v || !tt) return;
      const p = v.onTestFilesChanged(async (g) => {
        if (
          ((E.current = E.current.then(async () => {
            N(!0);
            try {
              const F = await v.listTests({
                projects: B.projects,
                locations: B.args,
                grep: B.grep,
                grepInvert: B.grepInvert,
              });
              tt.processListReport(F.report);
            } catch (F) {
              console.log(F);
            } finally {
              N(!1);
          ...
          return;
        const j = tt.asModel(),
          I = new ut('', j.rootSuite, j.loadErrors, c, B.pathSeparator, Q),
          P = [],
          U = new Set(g.testFiles);
        if (C) {
          const F = (y) => {
            const W = y.location.file;
            (W && U.has(W) && P.push(...I.collectTestIds(y)),
              y.kind === 'group' && y.subKind === 'folder' && y.children.forEach(F));
          };
          F(I.rootItem);
        } else
          for (const F of q.value) {
            const y = I.treeItemById(F),
      ...
      u.useEffect(() => {
        ...
        const p = (g) => {
          g.code === 'Backquote' && g.ctrlKey
            ? (g.preventDefault(), s(!e))
            : g.code === 'F5' && g.shiftKey
              ? (g.preventDefault(), v == null || v.stopTestsNoReply({}))
              : g.code === 'F5' && (g.preventDefault(), V('bounce-if-busy', b));
        };
        return (
          ...
          (ct(p),
            ...
            v == null ||
              v.installBrowsers({}).then(async () => {
                s(!1);
                const { hasBrowsers: g } = await (v == null ? void 0 : v.checkBrowsers({}));
                gt(g);
              }));
        },
        [ct, v],
      ...
      children: [
            ...
            children: [
              ...
              r.jsxs('div', {
                ...
                children: [
                  ...
                  r.jsx('br', {}),
                  r.jsx('button', { className: 'button', onClick: Ot, children: 'Install' }),
                  r.jsx('button', {
        ...
        jt &&
          r.jsxs('div', {
            ...
            children: [
              r.jsx('div', { className: 'title', children: 'UI Mode disconnected' }),
              r.jsxs('div', {
                children: [
                  r.jsx('a', {
                    href: '#',
            ...
            children: [
                ...
                children: [
                  r.jsxs(H, {
                    children: [
                      ...
                      r.jsx(O, { icon: 'close', title: 'Close', onClick: () => s(!1) }),
                    ],
                  }),
                  r.jsx(de, { source: z }),
                ],
              ...
              r.jsx('div', {
                ...
                children: r.jsx(be, {
                  pathSeparator: B.pathSeparator,
                  item: T,
                  rootDir: (_t = a == null ? void 0 : a.config) == null ? void 0 : _t.rootDir,
                  revealSource: Ct,
                  onOpenExternally: (p) =>
                    v == null
                      ? void 0
          ...
          sidebar: r.jsxs('div', {
            ...
            children: [
              r.jsxs(H, {
                ...
                noMinHeight: !0,
                children: [
                  r.jsx('img', { src: 'playwright-logo.svg', alt: 'Playwright logo' }),
                  r.jsx('div', { className: 'section-title', children: 'Playwright' }),
                  r.jsx(O, {
                    icon: 'refresh',
                    title: 'Reload',
                    onClick: () => it(),
              ...
              r.jsxs(H, {
                ...
                noMinHeight: !0,
                children: [
                  !L && !x && r.jsx('div', { className: 'section-title', children: 'Tests' }),
                  !L &&
                    x &&
                    r.jsx('div', {
              ...
              r.jsxs(H, {
                ...
                children: [
                  r.jsx('span', {
                    className: `codicon codicon-${st ? 'chevron-down' : 'chevron-right'}`,
                    style: { marginLeft: 5 },
                    title: st ? 'Hide Testing Options' : 'Show Testing Options',
                  }),
                  r.jsx('div', { className: 'section-title', children: 'Testing Options' }),
                ],
              }),
              st &&
                r.jsx(Zt, {
                  settings: [
                    { type: 'check', value: nt, set: Pt, name: 'Single worker' },
                    {
                      type: 'select',
                      options: [
                        { label: 'All', value: 'all' },
              ...
              r.jsxs(H, {
                ...
                children: [
                  r.jsx('span', {
                    className: `codicon codicon-${et ? 'chevron-down' : 'chevron-right'}`,
                    style: { marginLeft: 5 },
                    title: et ? 'Hide Settings' : 'Show Settings',
                  }),
                  r.jsx('div', { className: 'section-title', children: 'Settings' }),
                ],
              }),
              et && r.jsx(Gt, {}),
            ],
...
(async () => {
  if ((te(), window.location.protocol !== 'file:')) {
    if (
...
Make sure to serve the website (${window.location}) via HTTPS or localhost.`);
  ...
  ee.createRoot(document.querySelector('#root')).render(r.jsx(Te, {}));
})();
